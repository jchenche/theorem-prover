...
mod tests {
    ...
    fn test_to_clausal_form_1() {
        let formula = Forall! (
            ...
            And! (
                ...
                Neg! (
                    Pred! ("q", [Var! ("y"), Fun! ("f", [Var! ("y")]), Obj! ("c")])
                )
            )
    ...
    fn test_to_clausal_form_2() {
        let formula = Forall! (
            ...
            Forall! (
                ...
                Forall! (
                    ...
                    And! (
                        Or! (
                            Pred! ("p", [Var! ("x"), Fun! ("g", [Var! ("w"), Var! ("x"), Var! ("y")])]),
                            Pred! ("p", [Var! ("w"), Fun! ("f", [Var! ("w")])])
                        ),
                        Or! (
                            Neg! (
                                Pred! ("q", [Var! ("y"), Fun! ("g", [Var! ("w"), Var! ("x"), Var! ("y")])])
                            ),
                            Pred! ("p", [Var! ("w"), Fun! ("f", [Var! ("w")])])
                        )
                    )
        ...
        let p1 = Pred! ("p", [Var! ("x"), Fun! ("g", [Var! ("w"), Var! ("x"), Var! ("y")])]);
        let p2 = Pred! ("p", [Var! ("w"), Fun! ("f", [Var! ("w")])]);
        let p3 = Neg! (Pred! ("q", [Var! ("y0"), Fun! ("g", [Var! ("w0"), Var! ("x0"), Var! ("y0")])]));
